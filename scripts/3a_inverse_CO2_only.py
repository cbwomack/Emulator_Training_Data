#!/usr/bin/env python
"""
Companion script for 3a_inverse_CO2_only.ipynb: runs the CO2-only bilevel inverse-optimization
...
Usage:
    python 3a_inverse_CO2_only.py                        # run every experiment below, in order
    python 3a_inverse_CO2_only.py --experiment H-ext    # run just one
    python 3a_inverse_CO2_only.py --baseline-save-path checkpoints/.../baseline_x.pkl
"""
import os
import sys
...
# Exact hyperparameters transcribed programmatically from 3a_inverse_CO2_only.ipynb - see
