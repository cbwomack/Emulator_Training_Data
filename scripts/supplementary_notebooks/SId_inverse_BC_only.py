...
Usage:
    python SId_inverse_BC_only.py                        # run every experiment below, in order
    python SId_inverse_BC_only.py --experiment H-ext    # run just one
    python SId_inverse_BC_only.py --baseline-save-path checkpoints/.../baseline_x.pkl
"""
import os
import sys
...
DEFAULT_BASELINE_SAVE_PATH = 'checkpoints/BC/baseline_BC_only.pkl'

# Exact hyperparameters transcribed programmatically from supplementary/3e_inverse_BC_only.ipynb - see
